    ...
    return {
        ...
        initCharts: function () {
            ...
            function showTooltip(title, x, y, contents) {
                $('<div id="tooltip" class="chart-tooltip"><div class="date">' + title + '<\/div><div class="label label-success">DB: ' + x / 10 + '%<\/div><div class="label label-danger">CPU: ' + x * 12 + '<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                    top: y - 100,
                    width: 80,
        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Welcome to WordTree 0.01 Alpha!',
                    // (string | mandatory) the text inside the notification
                    text: 'WordTree enables the public to research books, dive into the unknown and solve the mysteries of the universe. Or at least, gain some perspective. We hope.',
